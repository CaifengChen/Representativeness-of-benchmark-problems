...
function fit = cec2010_func(x, func_num)
...
if (initial_flag == 0)
    if (jrandflag == 1)
        ...
        o = o';
		save 'F:/研究生工作/7测试集代表性研究/code/larges_functions/CEC2010/f01_o.mat' o;
    else
		load 'F:/研究生工作/7测试集代表性研究/code/larges_functions/CEC2010/f01_o.mat';
		o = o(1:D);
    end
	initial_flag = 1;
end
...
if (initial_flag == 0)
    if (jrandflag == 1)
        o = jrand.createShiftVector(D, lb, ub);
        o = o';
		save 'F:/研究生工作/7测试集代表性研究/code/larges_functions/CEC2010/f02_o.mat' o;
    else
		load 'F:/研究生工作/7测试集代表性研究/code/larges_functions/CEC2010/f02_o.mat';
		o = o(1:D);
    end
	initial_flag = 1;
end
...
if (initial_flag == 0)
    if (jrandflag == 1)
        o = jrand.createShiftVector(D, lb, ub);
        o = o';
		save 'F:/研究生工作/7测试集代表性研究/code/larges_functions/CEC2010/f03_o.mat' o;
    else
		load 'F:/研究生工作/7测试集代表性研究/code/larges_functions/CEC2010/f03_o.mat' o;
		o = o(1:D);
    end
	initial_flag = 1;
end
...
if (initial_flag == 0)
    if (jrandflag == 1)
		...
		save 'F:/研究生工作/7测试集代表性研究/code/larges_functions/CEC2010/f04_opm.mat' o p M;
    else
		load 'F:/研究生工作/7测试集代表性研究/code/larges_functions/CEC2010/f04_opm.mat';
    end
    if (D ~= 1000)
...
if (initial_flag == 0)
    if (jrandflag == 1)
        ...
        p = p'+1;
		M = jrand.createRotMatrix(m);
		save 'F:/研究生工作/7测试集代表性研究/code/larges_functions/CEC2010/f05_opm.mat' o p M;
    else
		load 'F:/研究生工作/7测试集代表性研究/code/larges_functions/CEC2010/f05_opm.mat';
    end
    if (D ~= 1000)
...
if (initial_flag == 0)
    if (jrandflag == 1)
        ...
        p = p'+1;
		M = jrand.createRotMatrix(m);
		save 'F:/研究生工作/7测试集代表性研究/code/larges_functions/CEC2010/f06_opm.mat' o p M;
    else
		load 'F:/研究生工作/7测试集代表性研究/code/larges_functions/CEC2010/f06_opm.mat';
    end
    if (D ~= 1000)
...
if (initial_flag == 0)
    if (jrandflag == 1)
        ...
        p = jrand.createPermVector(D);
        p = p'+1;
		save 'F:/研究生工作/7测试集代表性研究/code/larges_functions/CEC2010/f07_op.mat' o p;
    else
		load 'F:/研究生工作/7测试集代表性研究/code/larges_functions/CEC2010/f07_op.mat';
    end
    if (D ~= 1000)
...
if (initial_flag == 0)
    if (jrandflag == 1)
        ...
        p = jrand.createPermVector(D);
        p = p'+1;
		save 'F:/研究生工作/7测试集代表性研究/code/larges_functions/CEC2010/f08_op.mat' o p;
    else
		load 'F:/研究生工作/7测试集代表性研究/code/larges_functions/CEC2010/f08_op.mat';
    end
    if (D ~= 1000)
...
if (initial_flag == 0)
    if (jrandflag == 1)
        ...
        p = p'+1;
		M = jrand.createRotMatrix(m);
		save 'F:/研究生工作/7测试集代表性研究/code/larges_functions/CEC2010/f09_opm.mat' o p M;
    else
		load 'F:/研究生工作/7测试集代表性研究/code/larges_functions/CEC2010/f09_opm.mat';
    end
    if (D ~= 1000)
...
if (initial_flag == 0)
    if (jrandflag == 1)
        ...
        p = p'+1;
		M = jrand.createRotMatrix(m);
		save 'F:/研究生工作/7测试集代表性研究/code/larges_functions/CEC2010/f10_opm.mat' o p M;
    else
		load 'F:/研究生工作/7测试集代表性研究/code/larges_functions/CEC2010/f10_opm.mat';
    end
    if (D ~= 1000)
...
if (initial_flag == 0)
    if (jrandflag == 1)
        ...
        p = p'+1;
		M = jrand.createRotMatrix(m);
		save 'F:/研究生工作/7测试集代表性研究/code/larges_functions/CEC2010/f11_opm.mat' o p M;
    else
		load 'F:/研究生工作/7测试集代表性研究/code/larges_functions/CEC2010/f11_opm.mat';
    end
    if (D ~= 1000)
...
if (initial_flag == 0)
    if (jrandflag == 1)
        ...
        p = jrand.createPermVector(D);
        p = p'+1;
		save 'F:/研究生工作/7测试集代表性研究/code/larges_functions/CEC2010/f12_op.mat' o p;
    else
		load 'F:/研究生工作/7测试集代表性研究/code/larges_functions/CEC2010/f12_op.mat';
    end
    if (D ~= 1000)
...
if (initial_flag == 0)
    if (jrandflag == 1)
        ...
        p = jrand.createPermVector(D);
        p = p'+1;
		save 'F:/研究生工作/7测试集代表性研究/code/larges_functions/CEC2010/f13_op.mat' o p;
    else
		load 'F:/研究生工作/7测试集代表性研究/code/larges_functions/CEC2010/f13_op.mat';
    end
    if (D ~= 1000)
...
if (initial_flag == 0)
    if (jrandflag == 1)
        ...
        p = p'+1;
		M = jrand.createRotMatrix(m);
		save 'F:/研究生工作/7测试集代表性研究/code/larges_functions/CEC2010/f14_opm.mat' o p M;
    else
		load 'F:/研究生工作/7测试集代表性研究/code/larges_functions/CEC2010/f14_opm.mat';
    end
    if (D ~= 1000)
...
if (initial_flag == 0)
    if (jrandflag == 1)
        ...
        p = p'+1;
		M = jrand.createRotMatrix(m);
		save 'F:/研究生工作/7测试集代表性研究/code/larges_functions/CEC2010/f15_opm.mat' o p M;
    else
		load 'F:/研究生工作/7测试集代表性研究/code/larges_functions/CEC2010/f15_opm.mat';
    end
    if (D ~= 1000)
...
if (initial_flag == 0)
    if (jrandflag == 1)
        ...
        p = p'+1;
		M = jrand.createRotMatrix(m);
		save 'F:/研究生工作/7测试集代表性研究/code/larges_functions/CEC2010/f16_opm.mat' o p M;
    else
		load 'F:/研究生工作/7测试集代表性研究/code/larges_functions/CEC2010/f16_opm.mat';
    end
    if (D ~= 1000)
...
if (initial_flag == 0)
    if (jrandflag == 1)
        ...
        p = jrand.createPermVector(D);
        p = p'+1;
		save 'F:/研究生工作/7测试集代表性研究/code/larges_functions/CEC2010/f17_op.mat' o p;
    else
		load 'F:/研究生工作/7测试集代表性研究/code/larges_functions/CEC2010/f17_op.mat';
    end
    if (D ~= 1000)
...
if (initial_flag == 0)
    if (jrandflag == 1)
        ...
        p = jrand.createPermVector(D);
        p = p'+1;
		save 'F:/研究生工作/7测试集代表性研究/code/larges_functions/CEC2010/f18_op.mat' o p;
    else
		load 'F:/研究生工作/7测试集代表性研究/code/larges_functions/CEC2010/f18_op.mat';
    end
    if (D ~= 1000)
...
if (initial_flag == 0)
    if (jrandflag == 1)
        o = jrand.createShiftVector(D, lb, ub);
        o = o';
		save 'F:/研究生工作/7测试集代表性研究/code/larges_functions/CEC2010/f19_o.mat' o;
    else
		load 'F:/研究生工作/7测试集代表性研究/code/larges_functions/CEC2010/f19_o.mat';
    end
    if (D ~= 1000)
...
if (initial_flag == 0)
    if (jrandflag == 1)
        o = jrand.createShiftVector(D, lb, ub-1);
        o = o';
		save 'F:/研究生工作/7测试集代表性研究/code/larges_functions/CEC2010/f20_o.mat' o;
    else
		load 'F:/研究生工作/7测试集代表性研究/code/larges_functions/CEC2010/f20_o.mat';
    end
    if (D ~= 1000)
