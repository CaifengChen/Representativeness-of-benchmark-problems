...
function fit = cec2013_func(x, func_num)
global initial_flag 
persistent fhd
...
function fit = f1(x)
    ...
    [D ps] = size(x);
    if (initial_flag == 0)
        load 'F:\研究生工作\7测试集代表性研究\code\larges_functions/CEC2013/f01.mat';
        initial_flag = 1;
    end
...
function fit = f2(x)
    ...
    [D ps] = size(x);
    if (initial_flag == 0)
        load 'F:\研究生工作\7测试集代表性研究\code\larges_functions/CEC2013/f02.mat';
        initial_flag = 1;
    end
...
function fit = f3(x)
    ...
    [D ps] = size(x);
    if (initial_flag == 0)
        load 'F:\研究生工作\7测试集代表性研究\code\larges_functions/CEC2013/f03.mat';
        initial_flag = 1;
    end
...
persistent xopt p s R25 R50 R100 lb ub w
    ...
    [D ps] = size(x);
    if (initial_flag == 0)
        load 'F:\研究生工作\7测试集代表性研究\code\larges_functions/CEC2013/f04.mat';
        initial_flag = 1;
    end
...
persistent xopt p s R25 R50 R100 lb ub w
    ...
    [D ps] = size(x);
    if (initial_flag == 0)
        load 'F:\研究生工作\7测试集代表性研究\code\larges_functions/CEC2013/f05.mat';
        initial_flag = 1;
    end
...
persistent xopt p s R25 R50 R100 lb ub w
    ...
    [D ps] = size(x);
    if (initial_flag == 0)
        load 'F:\研究生工作\7测试集代表性研究\code\larges_functions/CEC2013/f06.mat';
        initial_flag = 1;
    end
...
persistent xopt p s R25 R50 R100 lb ub w
    ...
    [D ps] = size(x);
    if (initial_flag == 0)
        load 'F:\研究生工作\7测试集代表性研究\code\larges_functions/CEC2013/f07.mat';
        initial_flag = 1;
    end
...
persistent xopt p s R25 R50 R100 lb ub w
    ...
    [D ps] = size(x);
    if (initial_flag == 0)
        load 'F:\研究生工作\7测试集代表性研究\code\larges_functions/CEC2013/f08.mat';
        initial_flag = 1;
    end
...
persistent xopt p s R25 R50 R100 lb ub w
    ...
    [D ps] = size(x);
    if (initial_flag == 0)
        load 'F:\研究生工作\7测试集代表性研究\code\larges_functions/CEC2013/f09.mat';
        initial_flag = 1;
    end
...
persistent xopt p s R25 R50 R100 lb ub w
    ...
    [D ps] = size(x);
    if (initial_flag == 0)
        load 'F:\研究生工作\7测试集代表性研究\code\larges_functions/CEC2013/f10.mat';
        initial_flag = 1;
    end
...
persistent xopt p s R25 R50 R100 lb ub w
    ...
    [D ps] = size(x);
    if (initial_flag == 0)
        load 'F:\研究生工作\7测试集代表性研究\code\larges_functions/CEC2013/f11.mat';
        initial_flag = 1;
    end
...
function fit = f12(x)
    ...
    [D ps] = size(x);
    if (initial_flag == 0)
        load 'F:\研究生工作\7测试集代表性研究\code\larges_functions/CEC2013/f12.mat';
        initial_flag = 1;
    end
...
persistent xopt p s R25 R50 R100 m c lb ub w
    ...
    [D ps] = size(x);
    if (initial_flag == 0)
        load 'F:\研究生工作\7测试集代表性研究\code\larges_functions/CEC2013/f13.mat';
        c = cumsum(s);
        initial_flag = 1;
    end
...
persistent xopt p s R25 R50 R100 m c lb ub w
    ...
    [D ps] = size(x);
    if (initial_flag == 0)
        load 'F:\研究生工作\7测试集代表性研究\code\larges_functions/CEC2013/f14.mat';
        c = cumsum(s);
        initial_flag = 1;
    end
...
function fit = f15(x)
    ...
    [D ps] = size(x);
    if (initial_flag == 0)
        load 'F:\研究生工作\7测试集代表性研究\code\larges_functions/CEC2013/f15.mat';
        initial_flag = 1;
    end
