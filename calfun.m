...
switch nprob
    ...
    case 29
        y = matyas(x);  % 2D
    case 30
        y  = mich_m10(x);   % michalewics_m10 2D
    case 31
        y  = mich_m10(x);   % michalewics_m10 5D
    case 32
        y  = mich_m10(x);   % michalewics_m10 10D
    case 33
        y  = perm2(x);   % 4D
    case 34
        y  = powell(x); % 4D
    ...
    case 184
        y = xinsheyang2(x);     % xinsheyang2 2D
    case 185
    ...
    case 1094
        y  = mich_m1(x);   % michalewics_m1 2D
    case 1095
        y  = mich_m1(x);   % michalewics_m1 5D
    case 1096
        y  = mich_m1(x);   % michalewics_m1 10D
    case 1097
        y  = mich_m100(x);   % michalewics_m100 2D
    case 1098
        y  = mich_m100(x);   % michalewics_m100 5D
    case 1099
        y  = mich_m100(x);   % michalewics_m100 10D
    case 1100
        y = Li(x);  % Li 2D
    case 1101
        y = hart4(x);  % hart4 4D
    case 1102
        y = chsan10(x);  % % CHENG & SANDU 2010
    case 1103
        y = friedman(x);  % friedman 5D
    case 1104
        y = grlee09(x);  % GRAMACY & LEE (2009) FUNCTION
    case 1105
        y = limetal02non(x);  %LIM ET AL. (2002) NONPOLYNOMIAL FUNCTION
    case 1106
        y = curretal88exp(x);  %CURRIN ET AL. (1988) EXPONENTIAL FUNCTION 2D
    case 1107
        y  = curretal88explc(x); %CURRIN ET AL. (1988) EXPONENTIAL FUNCTION lower fidelity function 2D
    case 1108
        y = detpep10(x);  % DETTE & PEPELYSHEV (2010) 8D
    case 1109
        y = detpep10exp(x);  % DETTE & PEPELYSHEV (2010) EXPONENTIAL FUNCTION
    case 1110
        y = franke(x);  % franke 2D
    case 1111
        y = grlee08(x);  % GRAMACY & LEE (2008) FUNCTION 2D
    case 1112
        y = zhou98(x);  % ZHOU (1998) FUNCTION 2D
    case 1113
        y = zhou98(x);  % ZHOU (1998) FUNCTION 9D
    case 1114
        y = curretal91(x); % CURRIN ET AL. (1991) FUNCTION 2D
    case 1115
        y = limetal02pol(x);  % LIM ET AL. (2002) POLYNOMIAL FUNCTION
    case 1116
        y = welchetal92(x);  % WELCH ET AL. (1992) FUNCTION 20D
    case 1117
        y  =detpep10curv(x); %  % DETTE & PEPELYSHEV (2010) CURVED FUNCTION 3D
    case 1118
        y = eldetal07ratio(x);  %ELDRED ET AL. (2007) LOGNORMAL RATIO FUNCTION
    case 1119
        y = gfunc(x);  % G-function 2D
    case 1120
        y = gfunc(x);  % G-function 4D
    case 1121
        y = gfunc(x);  % G-function 20D
    case 1122
        y = ishigami(x); % ISHIGAMI FUNCTION 3D
    case 1123
        y = oakoh022d(x); % OAKLEY & O'HAGAN (2002) 2D
    case 1124
        y = park91a(x);  % PARK (1991) FUNCTION 1
    case 1125
        y = park91alc(x); % PARK (1991) FUNCTION 1 lower fidelity 
    case 1126
        y = park91b(x);  %PARK (1991) FUNCTION 1
    case 1127
        y = park91blc(x);% PARK (1991) FUNCTION 2 lower fidelity 
    case 1128
        y = moon10hd(x); % MOON (2010) HIGH-DIMENSIONALITY FUNCTION
    case 1129
        y = moon10hdc1(x); % MOON (2010) HIGH-DIMENSIONALITY FUNCTION C1
    case 1130
        y = moon10hdc2(x); % MOON (2010) HIGH-DIMENSIONALITY FUNCTION C2
    case 1131
        y = moon10hdc3(x); % MOON (2010) HIGH-DIMENSIONALITY FUNCTION C3
    case 1132
        y = moon10low(x); % MOON (2010) LOW-DIMENSIONALITY FUNCTION
    case 1133
        y = linketal06dec(x); % LINKLETTER ET AL. (2006) DECREASING COEFFICIENTS 10D
    case 1134
        y = linketal06simple(x); % LINKLETTER ET AL. (2006) SIMPLE FUNCTION 10D
    case 1135
        y = linketal06sin(x); % LINKLETTER ET AL. (2006) SINUSOIDAL FUNCTION 10D
    case 1136
        y = loepetal13(x);  % LOEPPKY ET AL. (2013) FUNCTION 10D
    case 1137
        y = morretal06(x); % MORRIS ET AL. (2006) FUNCTION 30D
    case 1138
        y = morcaf95a(x); % MOROKOFF & CAFLISCH (1995) FUNCTION 1 2D
    case 1139
        y = roosarn63(x);  % ROOS & ARNOLD (1963) FUNCTION 2D
    case 1140
        y = bratleyetal92(x); % BRATLEY ET AL. (1992) FUNCTION 2D
    case 1141
        y = soblev99(x); % SOBOL' & LEVITAN (1999) FUNCTION 2D
    case 1142
        y = willetal06(x); % WILLIAMS ET AL. (2006) FUNCTION 3D
    case 1143
        y = cont(x); % CONTINUOUS INTEGRAND FAMILY 2D
    case 1144
        y = copeak(x); % CORNER PEAK INTEGRAND FAMILY 2D
    case 1145
        y = disc(x); % DISCONTINUOUS INTEGRAND FAMILY 2D
    case 1146
        y = gaussian(x); % GAUSSIAN PEAK INTEGRAND FAMILY 2D
    case 1147
        y = oscil(x);% OSCILLATORY INTEGRAND FAMILY 2D
    case 1148
        y = prpeak(x); % PRODUCT PEAK INTEGRAND FAMILY 2D
    case 1149
        y = morcaf95b(x);  % MOROKOFF & CAFLISCH (1995) FUNCTION 2 2D      
end