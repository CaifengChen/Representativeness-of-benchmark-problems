...
if initial_flag==0
    ...
    initial_flag=1;
    fun_num=10;
    load F:/研究生工作/7测试集代表性研究/code/functions/novel_func/com_func1_data.mat % saved the predefined optima
    if length(o(1,:))>=D
         o=o(:,1:D);
    else
...
if initial_flag==0
    ...
    initial_flag=1;
    fun_num=10;
    load F:/研究生工作/7测试集代表性研究/code/functions/novel_func/com_func2_data.mat % saved the predefined optima
    if length(o(1,:))>=D
         o=o(:,1:D);
    else
         o=-5+10*rand(fun_num,D);
    ...
    lamda=repmat(lamda,1,D);
    if D==10
    load F:/研究生工作/7测试集代表性研究/code/functions/novel_func/com_func2_M_D10.mat,
    else
        for i=1:fun_num
...
if initial_flag==0
    ...
    initial_flag=1;
    fun_num=10;
    load F:/研究生工作/7测试集代表性研究/code/functions/novel_func/com_func3_data.mat % saved the predefined optima
    if length(o(1,:))>=D
         o=o(:,1:D);
    else
         o=-5+10*rand(fun_num,D);
    ...
    lamda=repmat(lamda,1,D);
    if D==10
    load F:/研究生工作/7测试集代表性研究/code/functions/novel_func/com_func3_M_D10.mat,
    else
        for i=1:fun_num
            eval(['M.M' int2str(i) '=orthm_generator(D);']);
        end
...
if initial_flag==0
    ...
    initial_flag=1;
    fun_num=10;
    load F:/研究生工作/7测试集代表性研究/code/functions/novel_func/hybrid_func1_data.mat % saved the predefined optima
    if length(o(1,:))>=D
         o=o(:,1:D);
    else
         o=-5+10*rand(fun_num,D);
    ...
    lamda=repmat(lamda,1,D);
    if D==10
    load F:/研究生工作/7测试集代表性研究/code/functions/novel_func/hybrid_func1_M_D10.mat,
    else
        for i=1:fun_num
            eval(['M.M' int2str(i) '=orthm_generator(D);']);
        end
...
if initial_flag==0
    ...
    initial_flag=1;
    fun_num=10;
    load F:/研究生工作/7测试集代表性研究/code/functions/novel_func/hybrid_func2_data.mat % saved the predefined optima
    if length(o(1,:))>=D
         o=o(:,1:D);
    else
         o=-5+10*rand(fun_num,D);
    ...
    lamda=repmat(lamda,1,D);
    if D==10
    load F:/研究生工作/7测试集代表性研究/code/functions/novel_func/hybrid_func2_M_D10.mat,
    else
        for i=1:fun_num
            eval(['M.M' int2str(i) '=orthm_generator(D);']);
        end
